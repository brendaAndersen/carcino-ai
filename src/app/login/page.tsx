        ...
        <Layout>
            ...
            <div
                className={`bg-banner dark:bg-none bg-cover bg-center flex justify-center items-center 
                    text-center w-screen min-h-[calc(100vh-90px)] text-white`}
            >
                <form className="flex w-96 flex-col gap-5 dark:bg-transparent bg-blue-500 p-10 rounded-md" onSubmit={handleSubmit(onSubmit)}>
                    <h1 className="text-2xl animate-slide-down">Doctor Login</h1>
                    <p className="animate-slide-down text-xs text-slate-200">
                    ...
                    <div className="relative z-0 w-full mb-5 group text-white">
                        <input
                            ...
                            type="text"
                            name="idCarcinocheck"
                            className="text-white block py-4 px- w-full text-sm bg-transparent border-0 border-b-2 appearance-none border-gray-300 dark:border-gray-600 focus:border-violet-250 peer font-thin"
                            placeholder=" "
                            required
                        />
                        <label
                            ...
                            peer-focus:scale-85 peer-focus:-translate-y-4 duration-300 text-white"
                        >
                            ID Carcinocheck
                        </label>
                    ...
                    <div className="relative z-0 w-full mb-5 group text-white">
                        <input
                            ...
                            type="password"
                            name="idCarcinocheck"
                            className="text-white block py-5 px- w-full text-sm bg-transparent border-0 border-b-2 appearance-none border-gray-300 dark:border-gray-600 focus:border-violet-250 peer font-thin"
                            placeholder=" "
                            required
                        />
                        <label
